...
public class Cat {
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		int y=catY;
		// Draw the head
		g2.setColor(Color.gray); //changed color from black to gray
		...
		g2.fillOval(x, y, EYE_WIDTH, EYE_HEIGHT);
		// Draw the mouth
		g2.setColor(Color.black); //changed mouth color to black
		x = catX + MOUTH_X;
		y = catY + MOUTH_Y;
		...
		g2.drawString("Meow Meow Purr", catX, catY+HEAD_DIMENSION+10);	// changed "Meow" to "Meow Meow Purr"
	}
}
